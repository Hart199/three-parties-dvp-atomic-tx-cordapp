...
import com.botkul.cordapp.buyer.flows.AssetSettlementResponderFlow
import com.botkul.cordapp.clearinghouse.flows.AssetSettlementInitiatorFlow
import com.botkul.cordapp.buyer.flows.ConfirmAssetTransferRequestInitiatorFlow
import com.botkul.cordapp.buyer.flows.CreateAssetTransferRequestResponderFlow
import com.botkul.cordapp.seller.flows.ConfirmAssetTransferRequestHandlerFlow
import com.botkul.cordapp.seller.flows.CreateAssetStateFlow
import com.botkul.cordapp.seller.flows.CreateAssetTransferRequestInitiatorFlow
...
abstract class AbstractAssetJunitFlowTests {
    ...
    @Before
    fun setup() {
        network = MockNetwork(listOf("com.botkul.cordapp", "net.corda.finance", "net.corda.finance.schemas"), threadPerNode = true)
        ...
        lenderOfSecurity.registerInitiatedFlow(com.botkul.cordapp.seller.flows.AssetSettlementResponderFlow::class.java)

        globalCustodian.registerInitiatedFlow(com.botkul.cordapp.clearinghouse.flows.ConfirmAssetTransferRequestResponderFlow::class.java)
